  ...
  return (
    <div className="login">
      <div className="login-card">
        <h2>로그인</h2>
        <p>Google 계정으로 로그인하여 악보 콘티 앱을 사용하세요.</p>
        <button onClick={signIn} className="btn-google-login">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
          ...
          >
            <path
              d="M17.64 9.20454C17.64 8.56636 17.5827 7.95272 17.4764 7.36363H9V10.845H13.8436C13.635 11.97 13.0009 12.9232 12.0477 13.5614V15.8195H15.9564C17.4382 14.5227 18.36 12.5545 18.36 9.20454Z"
              fill="#4285F4"
            />
            <path
